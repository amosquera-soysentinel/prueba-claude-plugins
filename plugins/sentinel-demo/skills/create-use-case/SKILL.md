...
Debes analizar solo el módulo indicado por el usuario y únicamente los archivos necesarios para construir el use case correctamente.
...
- contratos globales realmente usados por el módulo
...
## 3. Replica el patrón exacto del proyecto
...
## 6. Usa solo dependencias necesarias
